...
export const team: Person[] = [
  {
    ...
    portrait: placeholder(
      '4x5',
      'sandstone',
      'Portrait of Mairi Bracken, chest-up, natural window light, quiet stone interior',
      { mediaType: 'portrait' },
    ),
    order: 1,
  ...
  },
  {
    ...
    portrait: placeholder(
      '4x5',
      'stone',
      'Portrait of Thomas Roe, three-quarter crop, drawing background',
      { mediaType: 'portrait' },
    ),
    order: 2,
    verificationStatus: 'pending',
  ...
  },
  {
    ...
    portrait: placeholder(
      '4x5',
      'paper',
      'Portrait of Ailsa McLaren, eye level, lime-plaster interior',
      { mediaType: 'portrait' },
    ),
    order: 3,
    verificationStatus: 'pending',
  ...
  },
  {
    ...
    portrait: placeholder(
      '4x5',
      'sandstone',
      'Portrait of Jamie Kerr, chest-up, stair background',
      { mediaType: 'portrait' },
    ),
    order: 4,
    verificationStatus: 'pending',
  ...
  },
  {
    ...
    portrait: placeholder(
      '4x5',
      'stone',
      'Portrait of Niamh O’Donnell, three-quarter crop, window reveal',
      { mediaType: 'portrait' },
    ),
    order: 5,
    verificationStatus: 'pending',
  ...
  },
  {
    ...
    portrait: placeholder(
      '4x5',
      'paper',
      'Portrait of Fiona Campbell, chest-up, book and drawing background',
      { mediaType: 'portrait' },
    ),
    order: 6,
    verificationStatus: 'pending',
