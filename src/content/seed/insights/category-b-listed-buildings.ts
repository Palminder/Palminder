...
export const categoryBListedBuildings: Insight = {
  ...
  body: [{ type: 'paragraph', text: 'What Category B means, why listing is more than a façade designation, and how an alteration can begin with significance rather than style.' }],
  author: { type: 'studio' },
  publishedAt: '2026-06-01',
  reviewedAt: '2026-09-01',
  hero: placeholder('16x10', 'stone', 'Hero image for Understanding Category B listed buildings in Scotland'),
  officialSources: [],
